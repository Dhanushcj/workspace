                  ...
                  <div className="flex md:flex-col gap-2 overflow-x-auto md:overflow-y-auto md:overflow-x-hidden md:w-[200px] shrink-0 pb-2 md:pb-0">
                    ...
                    {pinnedUser !== 'local' && (
                      <div className="relative rounded-2xl overflow-hidden bg-slate-800 w-[140px] md:w-full aspect-video shrink-0 cursor-pointer group" onClick={() => setPinnedUser('local')}>
                        <video playsInline muted ref={userVideo} autoPlay className={`w-full h-full ${isScreenSharing ? 'object-contain' : 'object-cover'} ${(!videoOn && !isScreenSharing) ? 'opacity-0 absolute pointer-events-none -z-10' : ''} ${!isScreenSharing ? 'mirror' : ''}`} />
                 ...
                 return (
                  <React.Fragment>
                      ...
                      <div className={`relative rounded-3xl overflow-hidden bg-slate-800 ${tileClass} cursor-pointer group`}>
                         <video playsInline muted ref={userVideo} autoPlay className={`w-full h-full object-cover mirror ${(!videoOn) ? 'opacity-0 absolute pointer-events-none -z-10' : ''}`} />
                         {(!videoOn) && (
