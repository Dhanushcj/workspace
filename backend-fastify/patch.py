...
start_marker = 'async function generatePlan('
end_marker = '// ─── Pass 3: Validator / Gap Filler ──────────────────────────────────────────'
...
new_generate_plan = """async function generatePlan(
  pass1Result: any,
...
new_code = code[:start_idx] + new_generate_plan + code[end_idx:]

with open(path, 'w', encoding='utf-8') as f:
    f.write(new_code)

print('Successfully patched aiService.ts')
