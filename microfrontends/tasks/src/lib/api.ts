...
export const getApiUrl = () => {
  ...
  let url = process.env.NEXT_PUBLIC_API_URL || (import.meta as any).env.VITE_API_URL || (isLocalhost ? 'https://workspace-backend-r9f8.onrender.com/api' : 'https://workspace-backend-r9f8.onrender.com/api');
